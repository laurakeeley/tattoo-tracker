...
Client.create!([{name: "laura", email: "laura@gmail.com", password: "password", password_confirmation: "password", profile_image: "https://images.pexels.com/photos/1922528/pexels-photo-1922528.jpeg?auto=compress&cs=tinysrgb&dpr=2&w=500"}])
